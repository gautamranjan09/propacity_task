...
const HomePage = () => {
  ...
  return (
    <div className="flex-1 bg-[#03123D] p-4 md:p-8 overflow-auto ml-0 lg:ml-[16rem]">
      {selectedCategory === "Dashboard" && (
        <div className="flex flex-col gap-3 bg-[#FFFFFF] rounded-xl border-2 h-[386px] border-[#E0E6ED] p-4 md:p-6 max-w-[695px] mx-auto shadow-[0px_7px_34px_0px_rgba(23,23,37,0.25)]">
          <img src={dashboardImg} alt="Darth Vader" className="w-full h-64 object-cover rounded-lg" />
