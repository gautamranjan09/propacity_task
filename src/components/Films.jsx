      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex items-center">
          <input 
            ...
            className="mr-4 p-2 rounded bg-white/10 text-white"
          />
          <div className="flex space-x-2">
            <button 
              onClick={() => setViewMode('grid')}
              className={`p-2 rounded ${viewMode === 'grid' ? 'bg-pink-600 text-white' : 'bg-white/10 text-white'}`}
            >
              Grid
            </button>
            <button 
              onClick={() => setViewMode('list')}
              className={`p-2 rounded ${viewMode === 'list' ? 'bg-pink-600 text-white' : 'bg-white/10 text-white'}`}
            >
              List
            </button>
          </div>
